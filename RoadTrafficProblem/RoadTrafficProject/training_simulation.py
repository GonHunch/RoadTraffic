...
class Simulation:
    ...
    def run(self, episode, epsilon):
        ...
        while self._step < self._max_steps:
            ...
            # waiting time = seconds waited by a car since the spawn in the environment, summed for every car in incoming lanes
            ...
            # activate yellow phase when new phase is different to the current one
