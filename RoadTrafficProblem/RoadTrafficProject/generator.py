...
class TrafficGenerator:
    ...
    def generate_routefile(self, seed):
        ...
        """
        np.random.seed(seed)  # make reproducible tests
        ...
        car_gen_steps = np.rint(car_gen_steps)  # round values to int -> effective steps when a car will be generated
        ...
        with open("intersection/episode_routes.rou.xml", "w") as routes:
            ...
            for car_counter, step in enumerate(car_gen_steps):
                ...
                else:  # cars that turn, 25% of the time
